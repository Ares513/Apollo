...
//				g.drawRect(i*tileWidth - offset.x, j*tileHeight - offset.y, tileWidth, tileHeight);
	...
	private void drawGridLines(Graphics g) {
		int windowWidth = editCell.getWidth();
		int windowHeight = editCell.getHeight();
		...
		if(windowWidth > BootstrapperConstants.TILE_WIDTH * windowWidth) {
			higherX = windowWidth;
		}
		if(windowHeight > BootstrapperConstants.TILE_HEIGHT * windowHeight) {
			higherY = windowHeight;
		}
		
		int right = windowWidth * tileWidth;
		int bottom = windowHeight * tileHeight;
		for(int i=lowerX; i< higherX; i++) {
